...
describe("CoursesForm tests", () => {
    ...
    test("No Error messsages on good input", async () => {
        ...
        expect(screen.queryByText(/Start Date is greater than or equal to End Date/)).not.toBeInTheDocument();

    });

    test("Error messages on bad input (start date is greater than end date)", async () => {
        ...
        fireEvent.change(schoolField, { target: { value: 'ucsb' } });
        fireEvent.change(termField, { target: { value: 'f23' } });
        fireEvent.change(startDateField, { target: { value: '2024-01-02T12:00' } });
        fireEvent.change(endDateField, { target: { value: '2022-02-02T12:00' } });
        fireEvent.change(githubOrgField, { target: { value: 'cs156-f23'}})
        fireEvent.click(submitButton);
    ...
    test("Error messages on bad input (same start and end date)", async () => {
        ...
        fireEvent.change(schoolField, { target: { value: 'ucsb' } });
        fireEvent.change(termField, { target: { value: 'f23' } });
        fireEvent.change(startDateField, { target: { value: '2022-02-02T12:00' } });
        fireEvent.change(endDateField, { target: { value: '2022-02-02T12:00' } });
        fireEvent.change(githubOrgField, { target: { value: 'cs156-f23'}})
        fireEvent.click(submitButton);
